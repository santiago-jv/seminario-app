...
const ProductList = () => {
  ...
  useEffect(() => {
    if (categorySelected) {
      const filteredProducts = products.filter((product:any) => product.categoryId === categorySelected);
        ...
        <div className='conten-button-food-type'>
         {
          categories.map((category:any) => (
            <ButtonFoodType
              ...
              onClick={() => setCategorySelected(categorySelected === category.id ? null:category.id)}
              key={uuidv4()}
              name={category.name}
            />
          ))
        ...
        <div className='nav__container'>
          ...
          <ul className='dropdown'>
            <div className='conteainer-menu'>
              ...
              <NavLink to='/admin/boards' className='account-management link'>Manejo de Menú</NavLink>
              <Link to='/admin/boards' className='account-management link'>Manejo de Mesas</Link>
